...
//                 let html = "<h3>Your Sites:</h3><ul>";
//                 data.sites.forEach(site => {
//                     html += `<li>
//                         <strong>${site.name}</strong> 
//                         - <button onclick="editSite('${site._id}')">Edit Site</button>
//                         - <button onclick="deleteSite('${site._id}')">Delete Site</button>
//                         <ul>`;
//                     (site.pages || []).forEach(page => {
//                         html += `<li>
//                             Page: ${page.pageId} 
//                             - <button onclick="editPage('${site._id}','${page.pageId}')">Edit Page</button>
//                         </li>`;
//                     });
//                     html += `</ul></li>`;
//                 });
//                 html += "</ul>";
//                 userSitesDiv.innerHTML = html;
//             } else userSitesDiv.innerHTML = "<p>You have no sites yet.</p>";
//         } catch (err) {
//             console.error(err);
...
//                     li.innerHTML = `${p.pageId} - <button onclick="editPage('${site._id}','${p.pageId}')">Edit</button>`;
